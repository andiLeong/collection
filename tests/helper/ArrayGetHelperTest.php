...
use Tests\collection\CollectionTestCase;
...
class ArrayGetHelperTest extends CollectionTestCase
{
    ...
    {
        $value1 = array_get($this->arrayGet, 'name');
    ...
    {
        $value2 = array_get($this->arrayGetHelperCollection, 'name');
    ...
    {
        $value3 = array_get($this->arrayGetHelperCollection, 'foo', $this->default);
    ...
    {
        $value4 = array_get($this->arrayGetHelperCollection, 'kids.0.name');
    ...
    {
        $value5 = array_get($this->arrayGetHelperCollection, 'kids.0.name2222', $this->default);
